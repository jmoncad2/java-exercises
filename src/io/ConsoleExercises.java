...
import java.util.Scanner;
    ...
    public class ConsoleExercises {
        ...
        public static void main(String[] args) {
            ...
            // String quote = scan.next(); // This will only capture the first word of the quote
            scan.nextLine();
            ...
            scan.nextLine();
            String pizzaToppings = scan.nextLine();
